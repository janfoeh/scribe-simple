...
},{"../internals/slice":5,"../objects/isString":7,"../objects/values":9}],2:[function(require,module,exports){
...
},{"./objectTypes":3}],5:[function(require,module,exports){
...
},{"../internals/objectTypes":3}],7:[function(require,module,exports){
...
module.exports = keys;
},{"../internals/isNative":2,"../internals/shimKeys":4,"./isObject":6}],9:[function(require,module,exports){
...
},{"./keys":8}],10:[function(require,module,exports){
    ...
    return function (scribe) {
        ...
        function convert(str) {
            if (!/['"]/.test(str)) {
                ...
                var foo = str.replace(/([\s\S])?'/, replaceQuotesFromContext(openSingleCurly, closeSingleCurly)).replace(/([\s\S])?"/, replaceQuotesFromContext(openDoubleCurly, closeDoubleCurly));
                return convert(foo);
            }
        }
...
},{"lodash-amd/modern/collections/toArray":1}]},{},[10])(10)
});